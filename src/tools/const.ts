...
/** vscode 配置项前缀 */
export const CONFIG_GROUP = 'swaggerGenerateApi'
/** 模板配置文件名 */
export const TEMPLATE_FILE_NAME = 'swagger-to-types.template'
/** 默认模板配置文件路径 */
export const DEFAULT_TEMPLATE_FILE_PATH = path.join(EXT_PATH, 'templates/new.template.cjs')
